function twix_obj = mapVD(filename,varargin)
...
for s=1:NScans
    ...
    [mdh_blob, filePos, isEOF] = loop_mdh_read( fid );  % uint8; size: [ byteMDH  Nmeas ]
    ...
    [mdh, mask] = evalMDH( mdh_blob ); % this is quasi-instant (< 1s) :-)    
    clear mdh_blob
